		...
		*/
		_buildPrompt: function(field, promptText, type, ajaxed, options) {
			...
			if (options.showArrow) {
				...
				switch (positionType) {
					case "centerRight":
						prompt.find(".formErrorContent").addClass('arrow_box_right');
						break;
					case "centerLeft":
						prompt.find(".formErrorContent").addClass('arrow_box_left');
						break;
					case "bottomLeft":
					case "bottomRight":
			...
			/*--------------CODIGO ANEXADO AL ORIGINAL--------------*/
			var psTop = '';
			//console.log(!field.is('[type=radio]'));
			if(!field.is('[type=radio]') && positionType.indexOf("center") != -1){
				psTop = (parseFloat(pos.callerTopPosition) - 10 ) + 'px';
			} else {
				psTop = pos.callerTopPosition;
			}
			/*--------------TERMINA CODIGO ANEXADO--------------*/
		...
		*/
		_updatePrompt: function(field, prompt, promptText, type, ajaxed, options, noAnimation) {
			...
			if (prompt) {
				...
				/*--------------CODIGO ANEXADO AL ORIGINAL--------------*/
				var psTop = '';
				if(prompt.children().attr('class').indexOf("arrow_box") != -1){
					psTop = (parseFloat(pos.callerTopPosition) - 10 ) + 'px';
				} else {
					psTop = pos.callerTopPosition;
				}
