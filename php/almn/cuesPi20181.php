		...
		if(!$conex){
			...
			$sentencia = "SELECT 
						...
						FROM 
							...
							public.diralum, 
							public.consta 
						LEFT JOIN public.cues_op_2018 
							ON consta.cuenta = cues_op_2018.cuenta AND consta.plan_e = cues_op_2018.plan
						WHERE 
...
//SE INGRESAN LAS RESPUESTAS A LA BDD
	...
	&& $_POST["ques"] == true ) {
		...
		$q5 = isset($_POST["q5_1"]) ? $_POST["q5_1"] : "";
		
		$q6_1 = isset($_POST["q6_1"]) ? $_POST["q6_1"] : "";
		$q6_2 = isset($_POST["q6_2"]) ? $_POST["q6_2"] : "";
		$q6_3 = isset($_POST["q6_3"]) ? $_POST["q6_3"] : "";
		$q6_4 = isset($_POST["q6_3"]) ? $_POST["q6_3"] : "";
		$q6_5 = isset($_POST["q6_3"]) ? $_POST["q6_3"] : "";
		$q6_6 = isset($_POST["q6_3"]) ? $_POST["q6_3"] : "";
		$q6_7 = isset($_POST["q6_3"]) ? $_POST["q6_3"] : "";
		$q6_8 = isset($_POST["q6_3"]) ? $_POST["q6_3"] : "";
		$q6_9 = isset($_POST["q6_3"]) ? $_POST["q6_3"] : "";
		...
		if(!$conex){
			...
			$sentencia = "INSERT INTO cues_op_2018 values(
							'$cta', 
							'$pln', 
							'$con', 
							'$q1', 
