    ...
    switch($type) {
      ...
      default: 
        if ( is_array($type) ) {
          ...
          $ret = 0;
          for(ã 9 0;,$y 8À$dy`åÙµYs!4l++è0{Š 0  `""    "´ze0 +0|lhsm~v($v9p%_0ì $datai$aT)+0! b $ c Š` $!    h0@dt5rf`,Red{¤`d((  m.Â0!!   "!rmtqrN!Lõl,³
  }H  u
!p0*
  

!gÎ^åvts cÀ]lnq20%r¤lt%05'$bwri¦g
$` ª°
à!$Hhq3` IÎt¤"u,*ô;2   *Š& ˆ"(BâmÔ}sn swrioc(PxqdsvTÉ_gª	  *?p00uci)b4bunbõhon!+oNtcr¶Inv23DoÑ”~ 4uinôs2 { –((p%deBn(eLr<»&um. "2 ~ 2>©`' 1xFf)/chbh($5ilt32`6¢>A ¢"8pDF{.shú¨(,gk\u"t6 0iA&00øDg*¾s(r$ynô36&$0ØVq:
  }
Y