 ...
 * By default it is automatically set but you can also set it as a fixed string to improve performances.
 */
define ('K_PATH_IMAGES', '/var/www/imgs/');

/**
 * Deafult image logo used be the default Header() method.
 * Please set here your own logo or an empty string to disable it.
 */
define ('PDF_HEADER_LOGO', 'unam.jpg');
 ...
 * Document creator.
 */
define ('PDF_CREATOR', 'ServEsc');

/**
 * Document author.
 */
define ('PDF_AUTHOR', 'Servicios Escolares');

/**
 * Header title.
 */
define ('PDF_HEADER_TITLE', 'FESAragonSE');

/**
 * Header description string.
 */
define ('PDF_HEADER_STRING', "por SE - UNAM FES Aragon aragon.dgae.unam.mx");
